...
export type ArchiveSection = "list" | "album" | "collections" | "trash";
...
export default function ArchiveNavigation({ active, onNavigate }: {
  ...
  return <nav aria-label="Archive views" className="grid w-full grid-cols-2 rounded-lg border border-stone-200 bg-stone-100 p-1 sm:w-auto sm:grid-cols-4">
