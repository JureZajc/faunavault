...
import SmartCollectionsSection from "./smart-collections-section";
...
export default function CollectionsBrowser() {
  ...
  return <main className="min-h-screen bg-[#f7f8f4] text-stone-950">
    <div className="mx-auto max-w-7xl px-3 py-8 sm:px-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"><ArchiveNavigation active="collections" /><p className="text-sm text-stone-500 lg:text-right">Manual groups and live saved searches</p></div>
